...
(
  ...
  tx_status          varchar(20)  NOT NULL,
  workflow_status              INT,
  origin_tx_fees   BIGINT NOT NULL,
  aux_tx_fees   BIGINT NOT NULL,
  origin_avg_gas_price   BIGINT NOT NULL,
  aux_avg_gas_price   BIGINT NOT NULL,
  origin_total_gas_used   BIGINT NOT NULL,
  aux_total_gas_used   BIGINT NOT NULL,
...
(
    address_type_sk              BIGINT NOT NULL IDENTITY(0,1),
...
(
    ...
    address_type_sk    BIGINT  NOT NULL
)
