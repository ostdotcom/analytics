    ...
    static get mapping() {
        return new Map(
            [
                ...
                ['transaction_hash', {name: 'transaction_hash', isSerialized: false, required: true}],

                ['status', {name: 'status', isSerialized: false, required: true, between:[1, 2, 3, 4, 5, null]}],

                ['unique_hash', {name: 'unique_hash', isSerialized: false, required: true}],
