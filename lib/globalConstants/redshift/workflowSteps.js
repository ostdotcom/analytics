    ...
    static get mapping() {
        return new Map(
            [
                ...
                ['workflow_id', {name: 'workflow_id', isSerialized: false, required: false}],

                ['kind', {name: 'kind', isSerialized: false, required: true, max: 400}],

                ['transaction_hash', {name: 'transaction_hash', isSerialized: false, required: false}],

                ['status', {name: 'status', isSerialized: false, required: false, between:[1, 2, 3, 4, 5, null]}],
