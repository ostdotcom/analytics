...
class  Base {
    ...
    get getTableNameWithSchema(){
	  ...
	  static get createdTillYesterdayDataExtractionFetchType(){
		    return "createdTillYesterday";
	  }

	  static get createdTillCurrentTimeDataExtractionFetchType(){
		    return "createdTillCurrentTime";
	  }
