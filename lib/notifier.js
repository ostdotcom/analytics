...
class NotifierKlass {
     ...
     * @return {Promise<void>}
     */
    // async asyncPerformBack(code, msg, errData, debugData) {
    ...
    //
    //   if (!ostNotification) {
    //     console.warn('Failed to send email. ostNotification is null');
    //
    //     return;
    //   }
    //
    ...
    //     })
    //     .catch(function(err) {
    //       console.error('Message for airdrop router was not published. Payload: ', payload, ' Error: ', err);
    //     });
    //   console.info('......Lo bhai... ho gaya.......');
    // }
}
