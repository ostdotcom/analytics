    ...
    if (environment == 'production') {
      ...
      fromEmail = 'development.notifier@local.com';
        ...
        let d = {
            ...
            subject: `Error in Analytics:: Env: ${environment}, SubEnv: ${constants.SUB_ENVIRONMENT}, Env_suffix: ${constants.ENV_SUFFIX}, ${params.subject|| "Subject has not given"}`,
